...
public class JurosCompostos extends JDialog {
	...
	public JurosCompostos() {
		...
		setModal(true);
		setIconImage(Toolkit.getDefaultToolkit().getImage(JurosCompostos.class.getResource("/img/8666589_dollar_sign_icon (1).png")));
		setResizable(false);
		...
		btnCalcular.setIcon(new ImageIcon(JurosCompostos.class.getResource("/img/8666589_dollar_sign_icon (1).png")));
